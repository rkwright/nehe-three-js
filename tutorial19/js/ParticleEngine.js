...
ParticleEngine.prototype.initialize = function( gfxScene )
{
	...
	gfxScene.add( this.particleMesh );
};
...
ParticleEngine.prototype.update = function(dt)
{
	...
	{
		var n = recycleIndices[j];
		this.particleArray[n] = this.createParticle();
		this.particleArray[n].alive = 1.0; // activate right away
		this.particleGeometry.vertices[n] = this.particleArray[i].position;
	}
...
ParticleEngine.prototype.destroy = function( gfxScene )
{
    gfxScene.remove( this.particleMesh );
};
